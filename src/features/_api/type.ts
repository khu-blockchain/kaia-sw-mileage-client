import { DefaultError, UseMutationResult, UseQueryResult, UseSuspenseQueryResult } from "@tanstack/react-query";
...
type SuspenseQuery<TRequest, TResponse> = (args: TRequest) => UseSuspenseQueryResult<TResponse, DefaultError>
